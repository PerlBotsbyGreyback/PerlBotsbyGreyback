...
my $mynick = 'pippo';
my $passn = 'password';
my $ircd = 'irc.server.org';
my $porta = 6667;
my $channel = "#staff";
my $chanpass    = "spy";
my $channelspia = "#Spy";
my $admin = "passadmin";
my $admin2 = "^passadnib2^";
my $operNick = "passbot";
my $operPass = "abele241162";
my $numutenti   = 0;
my $ip          = "irc.server.org"; # <<== ip del server sul quale lo carichi
my $passwdChat = "pass DCC chat"; # <<== password di DCC chat
my $variabileStop = "NULL";
my $nickInizioShell = "xdcc"; # <<== inizio delle shell, Es: xdcc|news
my $checkCounter = 0;
my $checkCount = "off";
